...
#data
strength_selected <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx", 
                                sheet = "StrengthSelected")
swings_selected <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                              sheet = "SwingSelected")
bios <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                   sheet = "Bios")
strength_condensed <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                                 sheet = "StrengthCondensed")
strength_condensed_time_series <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                                             sheet = "StrengthCondensedTimeSeries")

strength_targets <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                               sheet = "StrengthTargets")

strength_percentiles <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                                   sheet = "StrengthPercentiles")

kinematic_data <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
                             sheet = "KinematicCurveData")

kinematic_percentiles <- read_excel("C:/Users/ficek/Documents/COSC 5500 Final App Data.xlsx",
